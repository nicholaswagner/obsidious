...
export type ExtendedComponentProps = ComponentProps<ElementType> &
    ExtraProps & { dataAttributes?: DataAttributes }
...
export const MarkdownComponents: MarkdownComponent = {
    ...
    p: (props: ExtendedComponentProps) => {
        ...
        return <p {...props} /> //<Typography variant="body2" component={'p'} {...props} />
    },
